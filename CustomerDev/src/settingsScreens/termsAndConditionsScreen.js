		...
		return (
			<HelpView style={screenStyle.container}>
				...
				<ScrollView
					...
					<Text style={fontStyles.bigTextStyleBlack}>Welcome to Help</Text>
					...
					<Text style={fontStyles.subTextStyleBlack}>13543 NE 200th St Woodinville 98072 - WA , United States</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.subTextStyleBlack}>You must not:</Text>
					<Text style={fontStyles.subTextStyleBlack}>Republish material from https://helpcocontact.wixsite.com/mysite</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Hyperlinking to our Content</Text>
					<Text style={fontStyles.subTextStyleBlack}>
						The following organizations may link to our Web site without prior written approval:
						<Text style={fontStyles.subTextStyleBlack}>Government agencies;</Text>
						<Text style={fontStyles.subTextStyleBlack}>Search engines;</Text>
						<Text style={fontStyles.subTextStyleBlack}>News organizations;</Text>
						<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.subTextStyleBlack}>
						...
						<Text style={fontStyles.subTextStyleBlack}>dot.com community sites;</Text>
						<Text style={fontStyles.subTextStyleBlack}>
							associations or other groups representing charities, including charity giving sites,
						</Text>{' '}
						<Text style={fontStyles.subTextStyleBlack}>online directory distributors;</Text>
						<Text style={fontStyles.subTextStyleBlack}>internet portals;</Text>
						<Text style={fontStyles.subTextStyleBlack}>
							accounting, law and consulting firms whose primary clients are businesses; and
						</Text>
						<Text style={fontStyles.subTextStyleBlack}>educational institutions and trade associations.</Text>
					</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.subTextStyleBlack}>Approved organizations may hyperlink to our Web site as follows:</Text>
					<Text style={fontStyles.subTextStyleBlack}>By use of our corporate name; or</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Iframes</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Reservation of Rights</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Removal of links from our app</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Content Liability</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Disclaimer</Text>
					<Text style={fontStyles.subTextStyleBlack}>
					...
					<Text style={fontStyles.bigTextStyleBlack}>Content Safety</Text>
					<Text style={fontStyles.subTextStyleBlack}>
