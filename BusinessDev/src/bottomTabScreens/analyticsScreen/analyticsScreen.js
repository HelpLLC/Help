...
export default function analyticsScreen(props) {
    ...
    function renderGraph(){
        ...
        const data = [revenueChart.chartData, topServicesChart.chartData, customerLocationData.chartData]
        ...
        switch(currentTab+''){
            case '0': return(
                <View>
                    ...
                    <LineChart
                        ...
                        <Shadow />
                        <Grid 
                        svg={{stroke:colors.darkBlue, strokeWidth:2, x:-10}}
                        />
                        <YAxis
                            data={revenueChart.chartData}
            ...
            const getKeyLabel = () => {
                switch(topServicesBy){
                    case strings.ByTotalRequests: return strings.ByRequests;
                    case strings.ByTotalRevenue: return strings.ByRevenue;
                    case strings.ByTotalViews: return strings.ByViews;
                }
            }
            return(
                <View>
                    <View style={{justifyContent:'space-between', flexDirection:'row', }}>
                        ...
                        <View style={[style.ChartDropdownContainer, {width:180}]}>
                            <Picker
                                ...
                                itemStyle={[fontStyles.subTextStyle, style.ChardDropdownLabels]} //NOTE: unforntunately this styling is only applied on IOS
                                onValueChange={(itemValue, itemIndex) =>
                                    setTopServicesBy(itemValue)
                                }
                                mode='dropdown'>
                                <Picker.Item label={'Sort '+strings.ByTotalRequests} value={strings.ByTotalRequests} />
                                <Picker.Item label={'Sort '+strings.ByTotalRevenue} value={strings.ByTotalRevenue} />
                    ...
                    <View style={{justifyContent:'space-between', flexDirection:'row', }}>
                        ...
                        <View style={[style.ChartDropdownContainer, {width:130}]}>
                            <Picker
                                ...
                                itemStyle={[fontStyles.subTextStyle, style.ChardDropdownLabels]} //NOTE: unforntunately this styling is only applied on IOS
                                onValueChange={(itemValue, itemIndex) =>
                                    setCustomerLocationsBy(itemValue)
                                }
                                mode='dropdown'>
