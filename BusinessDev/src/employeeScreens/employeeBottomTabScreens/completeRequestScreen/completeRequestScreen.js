...
export default function confirmServiceScreen(props) {
	...
	async function getData() {
		...
		const { requestID: RID } = props.navigation.state.params;
		setRequestID(RID);
					...
					<View style={style.FooterContainer}>
						<View style={style.CollumnContainer}>
							<TouchableOpacity
								...
								<Icon name={'truck'} type={'material-community'} size={60} color={colors.white} />
						...
						<View style={style.CollumnContainer}>
							<TouchableOpacity
								...
								disabled={travelStart == '' || jobStart != ''}>
								<Icon name={'play'} type={'material-community'} size={60} color={colors.white} />
