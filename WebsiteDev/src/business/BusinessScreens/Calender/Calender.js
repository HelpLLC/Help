  ...
  return (
    <div className="calendarContainer">
      ...
      <section className="calendarHolder">
        <div>
          <text className="darkGreen bold bigTextStyle">
            {strings.Calendar}
          </text>
        </div>
        <HelpCalendar
          ...
          onEventClick={async (request) => {
            ...
            const image = await FirebaseFunctions.call(
      ...
      <section className={"rightMenuContainer"}>
        {isRightMenuLoading === true ? (
          ...
          <div className={"column"}>
            ...
            <div className={"subTextStyle darkBlue bold alignStart"}>
              {requestClicked.time}
            </div>
          ...
          <div>
            ...
            {arrayOfDayRequests.map((request) => (
              <div className={"requestCard"}>
                ...
                <div className={"smallTextStyle darkBlue bold alignStart"}>
                  {request.time}
                </div>
                <HelpButton
                  title={strings.ViewMore}
