...
export default class PrivacyPolicy extends Component {
	render() {
		return (
         <div>
               <TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={50} text={'Welcome to Help'} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
						' These terms and conditions outline the rules and regulations for the use of Help\'s' +
						' app.' } />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'Help is located at: 13543 NE 200th St Woodinville 98072 - WA , United States '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'License'} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'You must not: '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'Republish material from https://helpcocontact.wixsite.com/mysite '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Hyperlinking to our Content '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
						' The following organizations may link to our Web site without prior written approval:'} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'Government agencies'} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'search engines'} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'News organizations'} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
						...
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'dot.com community sites; '} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
							' associations or other groups representing charities, including charity giving sites,' } />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'online directory distributors; '} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'internet portals; '} />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
							' accounting, law and consulting firms whose primary clients are businesses; and' } />
						<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'educational institutions and trade associations. />' } />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'Approved organizations may hyperlink to our Web site as follows: '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={'By use of our corporate name; or '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
						...
						' license agreement.' } />
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Iframes'} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Reservation of Rights'} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Removal of links from our app '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Content Liability '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Disclaimer '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
					...
					<TitleComponent  isCentered={true} backgroundColor={'inherit'} textColor={"#00B0F0"} fontSize={30} text={'Content Safety '} />
					<TitleComponent  isCentered={false} backgroundColor={'inherit'} fontSize={14} text={
