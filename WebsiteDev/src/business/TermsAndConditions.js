	...
	return (
		<div>
			...
			<TitleComponent
				...
				backgroundColor={'inherit'}
				fontSize={14}
				text={'Help is located at: 13543 NE 200th St Woodinville 98072 - WA , United States '}
			/>
			<TitleComponent
				isCentered={false}
				backgroundColor={'inherit'}
			...
			<TitleComponent
				...
				backgroundColor={'inherit'}
				fontSize={14}
				text={'Republish material from https://helpcocontact.wixsite.com/mysite '}
			/>
			<TitleComponent
				isCentered={false}
				backgroundColor={'inherit'}
				fontSize={14}
				text={' sell, rent or sub-license material from https://helpcocontact.wixsite.com/mysite'}
			/>
			<TitleComponent
				isCentered={false}
				backgroundColor={'inherit'}
			...
			<TitleComponent
				...
				backgroundColor={'inherit'}
				fontSize={14}
				text={' accounting, law and consulting firms whose primary clients are businesses; and'}
			/>
			<TitleComponent
				isCentered={false}
				backgroundColor={'inherit'}
			...
			<TitleComponent
				...
				backgroundColor={'inherit'}
				fontSize={14}
				text={'Approved organizations may hyperlink to our Web site as follows: '}
			/>
			<TitleComponent
				isCentered={false}
				backgroundColor={'inherit'}
			...
			<TitleComponent
				...
				textColor={'#00B0F0'}
				fontSize={30}
				text={'Removal of links from our app '}
			/>
			<TitleComponent
				isCentered={false}
				backgroundColor={'inherit'}
