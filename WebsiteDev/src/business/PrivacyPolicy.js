	...
	render() {
		return (
			<div>
				...
				/>
				<TitleComponent
					text={'Help is located at: Help LLC 13543 NE 200th St Washington, United States'}
					isCentered={false}
					backgroundColor={'inherit'}
					fontSize={14}
				/>
				<TitleComponent
					text={'Help can be contacted at: (425) 229-9185'}
					isCentered={false}
					backgroundColor={'inherit'}
					fontSize={14}
				/>
				<TitleComponent
					text={
						"It is Help LLC's policy to respect your privacy regarding any information we may" +
				...
				<TitleComponent
					text={
						" Certain visitors to Help LLC's" +
				...
				<TitleComponent
					text={
						" 'Help LLC may collect statistics about the behavior of visitors" +
				...
				<TitleComponent
					text={
						' To enrich and perfect your online experience, Help LLC uses "Cookies", similar' +
				...
				<TitleComponent
					text={
						' Although most changes are likely to be minor, Help LLC may' +
				...
				<TitleComponent
					text={
						' Collected email addresses in order to create account information from' + ' customers.'
					}
					isCentered={false}
					backgroundColor={'inherit'}
					fontSize={14}
				...
				<TitleComponent
					text={'Credit and Contact Information '}
					isCentered={true}
					textColor={'#00B0F0'}
					backgroundColor={'inherit'}
					fontSize={18}
