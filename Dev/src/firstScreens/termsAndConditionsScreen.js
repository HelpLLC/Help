      ...
      <HelpView style={screenStyle.container}>
        ...
        <ScrollView style={{ flex: 1, backgroundColor: colors.lightGray }}>
          ...
          <Text>
            ...
            not continue to use Help's website if you do not accept all of the terms and conditions
            stated on this page.
          </Text>
          <Text>
          ...
          <Text>Cookies</Text>
          <Text>
            We employ the use of cookies. By using Help's website you consent to the use of cookies
            in accordance with Help's privacy policy.
          </Text>
          <Text>
