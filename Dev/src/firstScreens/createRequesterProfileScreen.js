...
class createRequesterProfileScreen extends Component {
  ...
  async componentDidMount() {
    ...
    if (this.props.navigation.state.params.isEditing === true) {
      ...
      const imageSource = await FirebaseFunctions.getProfilePictureByID(
    ...
    if (
      ...
      if (this.state.isEditing === true) {
        ...
        try {
          ...
          const updatedRequeter = await FirebaseFunctions.getRequesterByID(
            requester.requesterID
          );
      ...
      <HelpView style={screenStyle.container}>
        ...
        >
          ...
          >
            ...
            <View
              style={{ width: Dimensions.get("window").width * 0.01 }}
            ></View>
            <Icon
              name={"info-circle"}
              type="font-awesome"
