...
class createProviderProfileScreen extends Component {
  ...
  async isCompanyNameTaken(businessName) {
    ...
    const ref = FirebaseFunctions.providers.where(
      'companyName',
      '==',
      businessName
    );
    ...
    if (this.state.businessName.trim() === '') {
      ...
      try {
        ...
        if (isCompanyNameTaken === true) {
          ...
          const provider = await FirebaseFunctions.addProviderToDatabase(
            account,
            email,
            businessName,
            businessInfo,
      ...
      <HelpView style={screenStyle.container}>
        <View>
          ...
          >
            <View style={{ flex: 1, justifyContent: 'flex-end' }}>
              <Text style={fontStyles.bigTextStyleBlack}>
                {strings.WhatsYourBusinessCalledQuestion}
              </Text>
            </View>
          ...
          >
            <View style={{ flex: 1, justifyContent: 'center' }}>
              <Text style={fontStyles.bigTextStyleBlack}>
                {strings.WhatDoesYourBusinessDoQuestion}
              </Text>
            </View>
