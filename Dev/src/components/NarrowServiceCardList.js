        ...
        rowsOfServices.push(
          ...
          >
            <NarrowServiceCard
              ...
              onPress={() => {
                this.goToServiceScreen(i);
              }}
            />
            <View
              style={{ width: Dimensions.get("window").width * 0.03 }}
            ></View>
            <View
        ...
        rowsOfServices.push(
          ...
          >
            ...
            <NarrowServiceCard
              ...
              price={
                this.props.dateRequested
                  ? services[i + 1].dateRequested
                  : services[i + 1].pricing
              }
              imageFunction={async () => {
                //Passes in the function to retrieve the image of this product
                return await FirebaseFunctions.getProductImageByID(
                  services[i + 1].serviceID
                );
              }}
              numCurrentRequests={0}
              //Passes all of the necessary props to the actual screen that contains
