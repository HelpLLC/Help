...
class categoryScreen extends Component {
  ...
  async componentDidMount() {
    ...
    let products = await FirebaseFunctions.getProductsByCategory(
      allProducts,
      categoryName
    );
    ...
    products = await FirebaseFunctions.filterProductsByRequesterLocation(
      requester,
      products
    );
  ...
  render() {
    ...
    return (
      <HelpView style={screenStyle.container}>
        ...
        <HelpSearchBar
          placeholderText={
            strings.SearchIn + " " + categoryName.toLowerCase() + "..."
          }
          value={search}
          onChangeText={text => {
            //Logic for searching
