//This class will represent the "Cleaning" tab within the categories that the requester can choose from
...
export default class Cleaning extends Component {
    ...
    componentDidMount() {
        FirebaseFunctions.setCurrentScreen("CleaningScreen", "Cleaning");
    }
    ...
    render() {
        ...
        const { cleaningProducts, requester } = this.props;
