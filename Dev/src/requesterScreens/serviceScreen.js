...
class serviceScreen extends Component {
  ...
  async fetchDatabaseData() {
    try {
      ...
      const url = await FirebaseFunctions.getProductImageByID(
        product.serviceID
      );
      const isRequested = product.requests.currentRequests.findIndex(
        request => {
      ...
      return (
        <HelpView style={screenStyle.container}>
              ...
              >
                ...
                this.state.isRequested === false ? (
                  ...
                  >
                    ...
                    >
                      <Text style={fontStyles.bigTextStyleBlue}>
                        {strings.ServiceRequested}
                      </Text>
                    </View>
                    <TouchableOpacity
                      onPress={() =>
                        this.setState({ isCancelRequestVisible: true })
                      }
                    >
          ...
          <OptionPicker
            ...
            title={strings.Block}
            message={
              strings.AreYouSureYouWantToBlock +
              " " +
              provider.companyName +
              "?"
            }
