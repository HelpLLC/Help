												...
												<View style={{ alignItems: 'center' }}>
													<View
														...
														<View style={{ flexDirection: 'row', flex: 1, alignItems: 'flex-end' }}>
															...
															<View style={{ flex: 1 }}>
																<Text style={fontStyles.mainTextStyleBlack}>{item.requesterName}</Text>
															</View>
														</View>
													</View>
													<View
														...
														<TouchableOpacity onPress={() => this.messageRequester(providerID, item.requesterID, item.requesterName)}>
														...
														<TouchableOpacity
															...
															<Text style={fontStyles.subTextStyleBlue}>{strings.MarkAsComplete}</Text>
														</TouchableOpacity>
