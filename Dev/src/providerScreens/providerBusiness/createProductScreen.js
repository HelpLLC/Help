...
class createProductScreen extends Component {
  ...
  async componentDidMount() {
    if (
      ...
      const imageSource = await FirebaseFunctions.getProductImageByID(
        productID
      );
        ...
        <View>
                  ...
                  >
                    <CachedImage
                      ...
                      style={{
                        ...
                        borderWidth:
                          (Dimensions.get("window").width * 0.25) / 17,
                        borderRadius:
                          (Dimensions.get("window").width * 0.25) / 2
                      }}
                    />
                  </BoxShadow>
                </View>
          ...
          <View style={{ marginTop: Dimensions.get("window").height * 0.05 }}>
            ...
            <MultiLineRoundedBoxInput
              ...
              onChangeText={input =>
                this.setState({ serviceDescription: input })
              }
