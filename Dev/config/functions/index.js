...
exports.sendNewBusinessEmail = functions.https.onCall(async (input, context) => {
    ...
    if (!providerID) {
        ...
        mailOptions.text = 'A new business has signed up on Help. Here is its information.\n\n' +
            ...
            "https://us-central1-help-d194d.cloudfunctions.net/verifyBusiness?businessEmail=" + businessEmail + "&providerID=" + providerID + '\n\n' +
            'To decline this business, click this link: \n' +
            "https://us-central1-help-d194d.cloudfunctions.net/declineBusiness?businessEmail=" + businessEmail + "&providerID=" + providerID +
            "\n\nHelp LLC";
    }
...
exports.verifyBusiness = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        mailOptions.text = "Your business has been verified on Help! We're super excited to welcome you to our family. Our goal " +
...
exports.declineBusiness = functions.https.onRequest(async (req, res) => {
    ...
    try {
        ...
        mailOptions.text = "We regret to inform you that your business could not be verified and will not " +
